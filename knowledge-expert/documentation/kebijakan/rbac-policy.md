...
4. **Rekomendasi jangka panjang:** ganti header `X-User-Role` dengan token terautentikasi (misalnya JWT/session yang divalidasi backend) agar role tidak dapat dipalsukan oleh client.